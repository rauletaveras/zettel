...
[editor]
# command = "hx"         # Override default editor
...
### Editor Integration
The CLI is designed for editor integration through shell commands
and can be easily integrated with Helix, Vim, Emacs, or VS Code.
...
with clear separation between CLI interface,
